...
import com.proyectoFinal.facade.HorarioFacade;
...
public class HorarioController implements Serializable {
    ...
    @EJB
    private com.proyectoFinal.facade.HorarioFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Horario) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("HorarioDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public Horario getHorario(java.lang.Long id) {
